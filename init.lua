...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      -- You need ripgrep to make this work, check "https://github.com/BurntSushi/ripgrep"
  ...
  { 'Bilal2453/luvit-meta', lazy = true },
  {
    ...
    config = function()
      ...
      local servers = {
        ...
        --   cmd = { '/Users/mohamed-issa/work/lsp/java-language-server/dist/lang_server_mac.sh' },
        -- },
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      -- Examples:
      -- - gcc  - comment all line
      -- - gciw - comment inner word
